...
$id = $_GET["id"];
$postDetail = $db->getPostDetail($id);
                        ...
                        <form action="add_post_comment.php" method="post" >
                            ...
                            <div class="container">
                                <div class="col-sm-12 "  style="position: page">
                                    <h2 class="tm-color-primary tm-post-title">Pridať komentár</h2>
                                    <hr class="tm-hr-primary tm-mb-45">
                                    <div class="form-group">
                                    ...
                                    <textarea name="content" rows="5" class="form-control" id="content" placeholder="Sem vložte text..."></textarea>
                                    <div class="text-right">
                                        <input type="hidden" name="post_id" value="<?php echo $id; ?>">
                                        <input type="submit" name="submit" class="btn btn-default" value="Odoslať">
                                    </div>
                                    </div>
                                </div>
                        </form>
